            ...
            s = e.spec = {
                ...
                buildRequests: function(a) {
                    ...
                    a.forEach((function(n) {
                        return n.sizes.map(w).filter((function(a) {
                            ...
                            var e;
                            t.push(n.params.placementId), r.push(n.params.format || a), i.push(a), o.push((e = n.params.format, _(e) ? "" : "5.5.web")), d.push(n.bidId)
                        }))
                    }));
                    ...
                    if (-1 !== s) {
                        var u = A(i[s]),
                            f = g(u, 2);
                        c.playerwidth = f[0], c.playerheight = f[1]
                    }
                    var m = (0, l.formatQS)(c);
                    return [{
                        adformats: r,
                        data: m,
                        method: "GET",
                ...
                interpretResponse: function(a, e) {
                    var t = a.body,
                        ...
                        h = e.requestIds,
                        v = e.sizes,
                        y = Number(i.config.getConfig().bidderTimeout),
                        n = t.bids,
                        r = void 0 === n ? {} : n;
                    return Object.keys(r).map((function(a) {
                        ...
                        if (_(d)) {
                            var p = x();
                            l.mediaType = "video", l.vastUrl = "https://an.facebook.com/v1/instream/vast.xml?placementid=" + i + "&pageurl=" + p + "&playerwidth=" + u + "&playerheight=" + f + "&bidid=" + r
                        }
                        return l
                    }))
                }
